...
mod tests {
    ...
    fn nested_struct_and_array() {
        ...
        let arr = Type::Array(Box::new(Type::plain_struct("Inner")), noir_common::ast::ConstVal::Lit(3));
    ...
    fn simd_and_fat_pointers() {
        ...
        let v2 = Type::Simd(Box::new(Type::Float32), noir_common::ast::ConstVal::Lit(2));
        assert_eq!((size_of(&v2, &s), align_of(&v2, &s)), (8, 8));
        let v4 = Type::Simd(Box::new(Type::Float32), noir_common::ast::ConstVal::Lit(4));
