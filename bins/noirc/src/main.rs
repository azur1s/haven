...
//   noir_common - AST + diagnostics, shared by everything
//   noir_front  - lex/parse, module load + merge (imports, mangling, prelude)
//   noir_mid    - typecheck, safety-check, monomorphize, lower to MIL
//   noir_back   - ABI/layout, LLVM IR emission
use noir_common::{ast, diag};
use noir_front::module;
use noir_mid::{typecheck, mono, safecheck, mil};
use noir_back::llvm;
